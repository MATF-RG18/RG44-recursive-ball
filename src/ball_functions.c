...
void ball_divition(int ball_id)
{
    if (balls[ball_id].alive == 1)
    {
        ...
        if (ball_id == 0)
        {
            ...
            balls[1].n_x = balls[0].n_x;
            balls[1].n_y = fabs(balls[0].n_y);
            balls[2].n_x = balls[0].n_x * (-1.0);
            balls[2].n_y = fabs(balls[0].n_y);
            balls[0].alive = 0;
            balls[1].alive = 1;
            balls[2].alive = 1;
        }
        ...
        else if (ball_id == 1)
        {
            ...
            balls[3].n_x = balls[1].n_x;
            balls[3].n_y = fabs(balls[1].n_y);
            balls[4].n_x = balls[1].n_x * (-1.0);
            balls[4].n_y = fabs(balls[1].n_y);
            balls[1].alive = 0;
            balls[3].alive = 1;
            balls[4].alive = 1;
        }
        else if (ball_id == 2)
        {
            ...
            balls[5].n_x = balls[2].n_x;
            balls[5].n_y = fabs(balls[2].n_y);
            balls[6].n_x = balls[2].n_x * (-1.0);
            balls[6].n_y = fabs(balls[2].n_y);
            balls[2].alive = 0;
            balls[5].alive = 1;
            balls[6].alive = 1;
        }
...
{
    GLfloat ambient_coeffs[] = {178.0 / 255.0, 19.0 / 255.0, 56.0 / 255.0, 1};
    GLfloat diffuse_coeffs[] = {225.0 / 255.0, 34.0 / 255.0, 75.0 / 255.0, 1};
